      ...
      <div className="Passengerdiv">
        ...
        <div className="mainDiv">
            ...
            <div className="passengerFormDiv">
              <div>
                ...
                <select id="preference" name="preference">
                  <option value="preference">NO preference</option>
              ...
              <div className="infantDetails">
                <div>
                  <button>Add Passenger/ Add Infant With Berth</button>
                  <button>Add Infant Without Berth</button>
                </div>
                <p>
                  *Children under 5 years of age shall be carried free and no
                  purchase of any ticket is required. (If no separate berth is
                  opted.)
                </p>
              </div>
            </div>
          ...
          <div className="ContactDetails">
            ...
            <div>
              <input type="phone" id="Contact" placeholder="mobile number" />
          ...
          <div className="payment">
            ...
            <div>
              ...
              <label htmlFor="html">Pay through Wallet </label><br />
              <p>Convenience Fee: ₹30/- + GST</p>
              <input type="radio" id="css" name="fav_language" value="CSS" />
              <label htmlFor="css">Pay through BHIM/UPI</label><br />
